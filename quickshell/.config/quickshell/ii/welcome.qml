...
ApplicationWindow {
    ...
    Process {
        ...
        command: ["bash", "-c", Quickshell.shellPath("scripts/colors/random/random_1_wall.sh")]
        stdout: SplitParser {
            onRead: data => {
                console.log(`wall proc output: ${data}`);
                ...
                ContentSection {
                    ...
                    RowLayout {
                        ...
                        RippleButtonWithIcon {
                            ...
                            StyledToolTip {
                                text: Translation.tr("Random images saved to ~/Pictures/Wallpapers")
                            }
                        }
                        RippleButtonWithIcon {
